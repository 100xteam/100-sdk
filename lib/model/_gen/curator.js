...
module.exports = function(sdk){
    ...
    curator.find = function(query, callback){
		...
		if(query.uri){
			...
			var uri = query._parent_uri + '/curators';
		}else if(query.location){
			var uri = '/locations/' + query.location + '/curators';
		}
		
        sdk.find(uri, query, function(err, curator_records){
	...
	curator.findOne = function(query, callback){
		if(_.isString(query)){
			...
			var uri = this._parent_uri + '/curators/' + query;
    ...
    curator.prototype.save = function(callback){
        if(!this.uri){
                ...
                this.uri = this._parent_uri + '/curators';
    ...
    curator.prototype.toObject = function(options){
        ...
        ret.api_url = this.api_url;
			...
			ret.inviteEmail = this.inviteEmail;
